        ...
        for row in reader:
            if row['Start Date'] == str(intwodays):
                ...
                if row['Trip Program'] == "Leadership" and row['Trip Active'] == "Yes":
                    message1 = "Hi " + row['PETrip Leaders'] + ",<br><br>You're leading the " + "<span style=\"color:darkviolet;\">" + row['Route'] + "</span> " + " " + dayleavingtext + "."
                else:
                    message1 = ""
...
#                message["To"] = row['email1']
                ...
                if row['Trip Active'] == "Yes" and row['Trip Program'] == "Leadership":
                    ...
                    print(row['PETrip Leaders'] + " on the " + row['Route'])
                elif:
                    print("No Leadership trips leaving in two days.")
